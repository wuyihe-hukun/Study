...
public class MyGridAdapter extends RecyclerView.Adapter<MyGridAdapter.LinearViewHolder> {
    ...
    //adapter的构造方法
    public MyGridAdapter(Context context, OnItemListener listener){
    ...
    //设置
    @Override
    public void onBindViewHolder(@NonNull MyGridAdapter.LinearViewHolder holder, final int position) {
